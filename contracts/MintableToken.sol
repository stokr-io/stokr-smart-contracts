...
contract MintableToken is ProfitSharing {
    ...
    function mint(address _to, uint _amount) public onlyMinter canMint {
        totalSupply = totalSupply.add(_amount);
        accounts[_to].balnce = accounts[_to].balnce.add(_amount);
        Minted(_to, _amount);
