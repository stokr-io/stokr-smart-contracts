...
contract KeyRecoverable is Ownable {
    ...
    KeyRecoverer public keyRecoverer;
    ...
    /// @dev Constructor
    /// @param _keyRecoverer A KeyRecoverer
    constructor(KeyRecoverer _keyRecoverer) public {
        require(IMPLEMENTATION);
    }

    /// @dev Set key recoverer
    /// @param _newKeyRecoverer A KeyRecoverer
    function setKeyRecoverer(KeyRecoverer _newKeyRecoverer) public onlyOwner {
        require(IMPLEMENTATION);
    }
