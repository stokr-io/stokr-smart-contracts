...
contract SicosCrowdsale is RefundableCrowdsale, CappedCrowdsale {
    ...
    constructor(SicosToken _token, uint _tokenCap, uint _tokenGoal, uint _openingTime, uint _closingTime, uint _rate, uint _teamShare, address _wallet) public RefundableCrowdsale(_goal) CappedCrowdsale(_cap) TimedCrowdsale(_openingTime,_closingTime) Crowdsale(_rate,_wallet,_token) {
