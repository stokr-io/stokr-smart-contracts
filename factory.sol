...
constructor(address _whitelist) public {
  ...
  */
    ...
    StokrToken token = new StokrToken("Name", "SYM", currentWhitelist, 0xDE, 0x01);
  ...
  StokrCrowdsale crowdsale = new StokrCrowdsale(token, 2e24, 1e24, 1e22, 100, 20000, 0xAD, now + 1 days, now + 2 days, 0xC0, 0, 0xAC);
